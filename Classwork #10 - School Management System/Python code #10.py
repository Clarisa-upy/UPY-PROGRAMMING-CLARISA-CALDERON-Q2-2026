#Input
usuarios = {
    'rherrera': {'password': '1234', 'rol': 'alumno',    'nombre': 'Rafita Herrera'},
    'lcervantes': {'password': '1234', 'rol': 'alumno',    'nombre': 'Luna Cervantes'},
    'acastillo': {'password': '1234', 'rol': 'alumno', 'nombre': 'Antonio Castillo'},
    'jperez': {'password': '1234', 'rol': 'alumno', 'nombre': 'Jessica Perez'},
    'rfuentes':  {'password': '1234', 'rol': 'alumno', 'nombre': 'Robert Fuentes'},
    'yfarah': {'password': '1234', 'rol': 'alumno', 'nombre': 'Yazmin Farah'},
# one teacher who teaches all subjects, one coordinator,
    'evilchis': {'password': '1234', 'rol': 'maestro',    'nombre': 'Enrique Vilchis'},
    'rsantos': {'password': '1234', 'rol': 'coordinador',    'nombre': 'Rodrigo Santos'}
}

materias = ('Matemáticas', 'Programación', 'Inglés')
calificaciones = {
    'rherrera':  {'Matemáticas': 8.5, 'Programación': 9.0, 'Inglés': 6.0},
    'lcervantes': {'Matemáticas': 9.0, 'Programación': 8.0, 'Inglés': 8.5},
    'acastillo': {'Matemáticas': 8.0, 'Programación': 8.5, 'Inglés': 7.5},
    'jperez': {'Matemáticas': 8.5, 'Programación': 6.0, 'Inglés': 8.0},
    'rfuentes':  {'Matemáticas': 7.5, 'Programación': 8.0, 'Inglés': 8.5},
    'yfarah': {'Matemáticas': 3.0, 'Programación': 8.5, 'Inglés': 8.0}
}
